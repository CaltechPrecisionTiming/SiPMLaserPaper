...
//=========  (Wed Aug  9 17:58:21 2017) by ROOT version6.08/05
   TCanvas *c1 = new TCanvas("c1", "c1",532,152,800,600);
   gStyle->SetOptStat(0);
   ...
   DSB1ch1__5->SetBinContent(94521,1);
   DSB1ch1__5->SetEntries(5);
   ...
   DSB1ch1__5->GetYaxis()->SetRange(1,600);
   ...
   TH2F *DSB1ch2__6 = new TH2F("DSB1ch2__6","1000*tree_DSB1_time_2:tree_Energy",250,0,250,600,0,400);
   ...
   DSB1ch2__6->SetBinContent(55713,1);
   DSB1ch2__6->SetEntries(5);
   ...
   TH2F *DSB1ch3__7 = new TH2F("DSB1ch3__7","1000*tree_DSB1_time_3:tree_Energy",250,0,250,1200,0,800);
   ...
   DSB1ch3__7->SetBinContent(84441,1);
   ...
   TH2F *DSB1ch4__8 = new TH2F("DSB1ch4__8","1000*tree_DSB1_time_4:tree_Energy",250,0,250,600,0,400);
   ...
   DSB1ch4__8->SetBinContent(51177,1);
   DSB1ch4__8->SetEntries(5);
