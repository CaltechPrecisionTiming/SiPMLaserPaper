...
the light is directed onto the MCP-PMT while the other half of the
...
cell, is used to select events impinging on the calorimeter cell. The
...
Figure~\ref{fig:TestbeamSetup} below. More details of the calorimetric
