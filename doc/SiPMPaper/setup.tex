...
have a faster rise time. We observe that a high-pass filter that reduces the
rise time from $10$~ns to $2$~ns will also reduce the signal amplitude from
$100$~mV to $15$~mV. The SiPMs are mechanically attached to an optical
