...
%As photons typically impact on the SiPM area randomly, signals with more photons than available 
%pixels can still be measured as some pixels will be hit by multiple photons.
