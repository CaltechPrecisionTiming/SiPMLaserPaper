...
photoelectron signal is estimated to be X~mV for the $1\times1$~$\mathrm{mm}^{2}$ 
S12571-015P SiPM and Y~mV for 
...
SiPM devices are small and a factor of X smaller. Therefore the time resolution
